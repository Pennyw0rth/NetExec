...
def proto_args(parser, parents):
    ...
    mapping_enum_group.add_argument("--shares-export", type=str, metavar="FILE", help="Export enumerated shares to a CSV file (format: IP;HOSTNAME;SHARE;PERMISSIONS;REMARK)")
