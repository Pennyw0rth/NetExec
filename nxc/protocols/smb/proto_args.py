...
def proto_args(parser, parents):
    ...
    coercer_group.add_argument("--coercer-method", dest="coercer", action="store", default="all", choices={"all", "shadowcoerce", "dfsoerce", "petitpotam", "printerbug", "cheeseounce", "wspcoerce"}, nargs="?", type=str.lower, help="AAAAAAAAAA")
