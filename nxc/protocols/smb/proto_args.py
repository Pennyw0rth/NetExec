...
def proto_args(parser, parents):
    ...
    rpc_group.add_argument("--rpc-users", action="store_true", dest="rpc_users", help="Enumerate domain users via SAMR")
    rpc_group.add_argument("--rpc-dispinfo", action="store_true", dest="rpc_dispinfo", help="Query display info with details")
    rpc_group.add_argument("--rpc-groups", action="store_true", dest="rpc_groups", help="Enumerate domain groups via SAMR")
    rpc_group.add_argument("--rpc-local-groups", action="store_true", dest="rpc_local_groups", help="Enumerate local/alias groups")
    ...
    rpc_group.add_argument("--rpc-shares", action="store_true", dest="rpc_shares", help="Enumerate shares via SRVS RPC")
    rpc_group.add_argument("--rpc-share", metavar="SHARE", dest="rpc_share", help="Get specific share info")
