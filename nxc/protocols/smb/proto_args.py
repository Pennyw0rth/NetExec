...
def proto_args(parser, parents):
    ...
    mapping_enum_group.add_argument("--file-write-check", action="store_true", help="Use file creation to check WRITE access on shares (default: ACL-based check, no disk writes)")
