...
def gen_cli_args():
   ...
   ˙ \   / ˙
    ...
    credential_group.add_argument("--delay", metavar="SECONDS", dest="delay", type=float, default=0, action=DefaultTrackingAction, help="fixed delay in seconds between every authentication attempt (added on top of --jitter)")
