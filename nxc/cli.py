...
def gen_cli_args():
    ...
    generic_group.add_argument(
        ...
        default=None,
        type=int,
        help="[DEPRECATED] no longer used, replaced by per-protocol timeouts (--smb-timeout, --ldap-timeout, --dcom-timeout)",
    )
    generic_group.add_argument(
        "--jitter",
        metavar="INTERVAL",
    ...
    output_group.add_argument(
        "-j", "--json", action="store_true", help="output results as JSON lines"
    )
