...
def gen_cli_args():
    ...
    generic_group = generic_parser.add_argument_group(
        "Generic", "Generic options for nxc across protocols"
    )
    ...
    output_group = output_parser.add_argument_group(
        "Output", "Options to set verbosity levels and control output"
    )
   ...
   ˙ \   / ˙
    ...
    credential_group = std_parser.add_argument_group(
        "Authentication", "Options for authenticating"
    )
    ...
    kerberos_group = std_parser.add_argument_group(
    ...
    certificate_group = std_parser.add_argument_group(
        "Certificate", "Options for certificate authentication"
    )
