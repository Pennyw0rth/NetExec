...
# Ensure raw formatter with defaults displayed
class DisplayDefaultsNotNoneRaw(DisplayDefaultsNotNone, RawTextHelpFormatter):
    """Show default values and respect newlines."""
    pass
...
def gen_cli_args():
    ...
    generic_parser = argparse.ArgumentParser(add_help=False, formatter_class=DisplayDefaultsNotNoneRaw)
    ...
    output_parser = argparse.ArgumentParser(add_help=False, formatter_class=DisplayDefaultsNotNoneRaw)
    ...
    dns_parser = argparse.ArgumentParser(add_help=False, formatter_class=DisplayDefaultsNotNoneRaw)
...
""",
    ...
    std_parser = argparse.ArgumentParser(
        add_help=False,
        parents=[generic_parser, output_parser, dns_parser],
        formatter_class=DisplayDefaultsNotNoneRaw
    )
    ...
    # --- Attach module listing epilog with alignment ---
    for proto_name, proto_parser in proto_subparsers.choices.items():
        ...
        try:
            ...
            proto_parser.formatter_class = DisplayDefaultsNotNoneRaw  # <<< ensure raw formatting
        except Exception:
            pass

    # --- Special-case: module help (-M <module> -h) ---
    ...
    # --- DOUBLE PARSING: module arguments ---
