...
class NXCModule:
    ...
    def on_login(self, connection):
        ...
        self.context.log.display(f"Starting LDAP search with search filter '{search_filter}'")
        ...
        try:
            ...
            if "noSuchObject" in str(e):
                self.context.log.fail("No ADCS infrastructure found.")
            else:
                self.context.log.fail(f"Obtained unexpected exception: {e}")
