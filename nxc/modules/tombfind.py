...
class NXCModule:
    ...
    def on_login(self, context, connection):
        try:
            ...
            context.log.error(f"Module execution error: {str(e)}")
        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    context.log.error(f"Search error: {str(e)}")
                    break
            ...
            if self.output_file:
                try:
                    ...
                    context.log.error(f"Failed to write to file: {str(e)}")

        except Exception as e:
            context.log.error(f"Error in find operation: {str(e)}")
            context.log.debug(f"Exception details: {e}", exc_info=True)
